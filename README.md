...
Impacto transformador de la IA en la inclusión educativa.
Herramientas de voz y reconocimiento del habla.
Procesamiento de Lenguaje Natural (NLP).
Limitaciones técnicas y desafíos éticos.
Necesidad de políticas y formación.
...
Anatomía: Ambos tienen border-radius: 50% y clip-path: polygon(...) recortándolos exactamente por la mitad.
Estado Inicial: El semicírculo azul está visible en rotate(0deg). El semicírculo verde está oculto detrás con rotate(180deg).
Animación (li:hover): Se aplica transform: rotate(-180deg) al azul y rotate(0deg) al verde. Esto crea la ilusión óptica de que las mitades se unen mágicamente para formar un círculo completo que cambia de color.
Restricción cumplida: transition: all 0.4s ease-in-out controla la suavidad del movimiento.
Efecto #2: Línea de Menú Ondulada bajo el Título
Para lograr este efecto sin SVGs externos ni JS:

Integración: Se insertó un <span class="linea-ondulada"> dentro del <h2> con position: absolute en la parte inferior.
Textura: Se utilizó un vector SVG codificado en Base64 como propiedad background-image. El color de la onda está incrustado en el código Base64 (fill='%2310B981').
Animación: En estado reposo, el width es 0 y opacity: 0. Al hacer hover en el <li>, se expande al 100% y se dispara la regla @keyframes mover-onda, la cual desplaza el background-position en el eje X de forma infinita, simulando el movimiento de una ola en el mar.
👨‍💻 Cómo Personalizar
...
Fuente Científica (Contenido):AI-driven assistive technologies in inclusive education: benefits, challenges, and policy recommendations. DOI: https://doi.org/10.1016/j.sftr.2025.101042



AI-driven assistive technologies in inclusive education: benefits, challenges, and policy recommendations. DOI: https://doi.org/10.1016/j.sftr.2025.101042
